 ...
 */
public class ConnectAllNeigbors extends AbstractMetricStructure{
    //private int succeedThreshould = 5;
    private int succeedThreshould;
    
    public ConnectAllNeigbors(int succeedThreshould) {
        super();
    ...
    public String toString() {
        return "Self Adapted Metrized Small World [Connect All Neighbors]\t" + 
