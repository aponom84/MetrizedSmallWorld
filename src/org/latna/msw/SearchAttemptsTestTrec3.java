...
/**
 * The simple example of MetrizedSmallWorld usage on the trec-3 collection data set.
 * Any document or query is represented by term frequency verctor.
 ...
 * 
 * The second stage - to obtain the true nearest neigbor element for every query by the use sequenteally scan
 * 
